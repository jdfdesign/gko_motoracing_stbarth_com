class JetskisController < ContentsController
  respond_to :html, :js
  belongs_to :jetski_list
  ...
  def load_resources
    end_of_association_chain.includes(self.includes).with_globalize.order('jetskis.cylinder, jetskis.price')
  end
