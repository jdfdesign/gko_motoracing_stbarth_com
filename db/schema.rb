...
ActiveRecord::Schema.define(:version => 20131113105335) do
  ...
  create_table "motorcycle_translations", :force => true do |t|
  ...
  add_index "motorcycle_translations", ["locale"], :name => "index_motorcycle_translations_on_locale"
  add_index "motorcycle_translations", ["motorcycle_id"], :name => "index_motorcycle_translations_on_motorcycle_id"
